...
var pug_match_html=/["&<>]/;function crearTeclados(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (filtros, productos) {pug_html = pug_html + "\u003Csearch class=\"grid-search\"\u003E\u003Cform action=\"aplicar a la vista\"\u003E\u003Cfieldset\u003E\u003Cp\u003EFiltros:\u003C\u002Fp\u003E\u003Cspan\u003E \u003Clabel\u003EPrecio ascendente: \u003Cinput type=\"radio\" name=\"ordenar_precio\" value=\"radio1\"\u002F\u003E\u003C\u002Flabel\u003E\u003Clabel\u003EPrecio descendente: \u003Cinput type=\"radio\" name=\"ordenar_precio\" value=\"radio2\"\u002F\u003E\u003C\u002Flabel\u003E";
if (filtros.length > 0) {
if (filtros[0].marca) {
pug_html = pug_html + "\u003Cdiv class=\"contenedor-select-marca\"\u003EMarca:\u003Cselect id=\"marca\"\u003E";
// iterate filtros
;(function(){
  var $$obj = filtros;
...
pug_html = pug_html + "\u003Cdiv class=\"contenedor-select-marca\"\u003EAutor:\u003Cselect id=\"marca\"\u003E";
// iterate filtros
;(function(){
  var $$obj = filtros;
  if ('number' == typeof $$obj.length) {
...
pug_html = pug_html + "\u003Cdiv class=\"contenedor-select-marca\"\u003EFiltro:\u003Cselect id=\"marca\"\u003E\u003C\u002Fselect\u003E\u003C\u002Fdiv\u003E";
}
...
pug_html = pug_html + "\u003C\u002Farticle\u003E";}.call(this,"filtros" in locals_for_with?locals_for_with.filtros:typeof filtros!=="undefined"?filtros:undefined,"productos" in locals_for_with?locals_for_with.productos:typeof productos!=="undefined"?productos:undefined));;return pug_html;}